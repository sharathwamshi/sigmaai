...
async def handle_callback(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "menu:main":
        await q.edit_message_text(
            build_welcome(update.effective_user.first_name),
    ...
    # ── Categories ───────────────────────────────────────────────
        ...
        await q.edit_message_text(
            ...
            parse_mode="Markdown",
            reply_markup=products_in_category_kb(category),
        )
    ...
    # ── Prices category picker ────────────────────────────────────
        ...
        await q.edit_message_text(
            ...
            f"`{DIV}`\n"
            f"Pricing available for *{total} products*.\n"
            f"All prices shown in Indian Rupees (₹).\n\n"
            f"Select a category to view prices:",
            parse_mode="Markdown", reply_markup=prices_category_kb(),
        )
        ...
        await q.edit_message_text(
            ...
            parse_mode="Markdown",
            reply_markup=prices_list_kb(category),
        )
    ...
    # ── Dealer regions ────────────────────────────────────────────
        ...
        await q.edit_message_text(
            ...
            f"`{DIV}`\n"
            f"*{total}+ authorised dealers* across India.\n"
            f"Select your region to find dealers near you:",
            parse_mode="Markdown", reply_markup=dealer_regions_kb(),
        )
        ...
        if not dealers:
            await q.edit_message_text(
                ...
                f"Please visit [sigmaindia.in/dealer-network/](https://sigmaindia.in/dealer-network/) for the latest listings.",
                parse_mode="Markdown",
                reply_markup=kb([("⬅️  Regions", "menu:dealers"), ("🏠  Main Menu", "menu:main")]),
                disable_web_page_preview=True,
            )
            return
        ...
        await q.edit_message_text(
            ...
            parse_mode="Markdown",
            reply_markup=dealer_list_kb(region_key, dealers),
        )
    ...
    # ── Service centres ───────────────────────────────────────────
        ...
        await q.edit_message_text(
            ...
            parse_mode="Markdown",
            reply_markup=service_list_kb(centers),
        )
